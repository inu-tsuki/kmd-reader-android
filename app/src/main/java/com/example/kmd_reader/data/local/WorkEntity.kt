...
data class WorkEntity(
    ...
    val scriptRevisionLabel: String,
    val scriptSourceUrl: String,
    val scriptMimeType: String,
    val scriptKmdVersion: String,
    val scriptRuntimeVersion: String,
    val scriptRevisionCreatedAt: String,
    val scriptContentHash: String?,
    val assetManifestBaseUrl: String?,
    val assetManifestAssets: String,
