...
- [Roadmap](planning/roadmap.md)：Android Reader 当前状态、技术风险和后续开发路线。
...
- [Runtime UI 抽取计划](planning/runtime/runtime-ui-extraction-plan.md)：当前 runtime UI 阶段应抽出的源码上下文、anchor 和 companion 边界。
